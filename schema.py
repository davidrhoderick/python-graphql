...
class Mutation:
    ...
    toggle_sub_item_completion = strawberry.mutation(
        resolver=toggle_sub_item_completion
    )
    delete_item = strawberry.mutation(resolver=delete_item)
    delete_sub_item = strawberry.mutation(resolver=delete_sub_item)
